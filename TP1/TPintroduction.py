...
def viewimage(im,normalise=True,MINI=0.0, MAXI=255.0):
    """ Cette fonction fait afficher l'image EN NIVEAUX DE GRIS 
        dans 
. Si un gimp est deja ouvert il est utilise.
...
im=noise(skio.imread('C:/Users/march/Desktop/Tetech_cours/2A/IMA_201/TP/TP_12092022/images/sombre.jpg'),1)
...
im=skio.imread('C:/Users/march/Desktop/Tetech_cours/2A/IMA_201/TP/TP_12092022/images/sombre.jpg')
...
#%% 
u=skio.imread('C:/Users/march/Desktop/Tetech_cours/2A/IMA_201/TP/TP_12092022/images/vue1.tif')
v=skio.imread('C:/Users/march/Desktop/Tetech_cours/2A/IMA_201/TP/TP_12092022/images/vue2.tif')
...
plt.imshow(unew,cmap="gray") #u avec l'histogramme de v
plt.show()
